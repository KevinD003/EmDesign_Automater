...
| **Document version** | **v45** |
| **Times updated** | **45** |
| **Last updated** | 2026-07-29 |
| **Current phase** | v2 improvement plan: Parts 0–8 complete · **Part 9 (floor regression closed, 5→3) complete**. |
| **Git branch** | `claude/code-quality-improvements-hyu6dg` |
| **Latest code commit** | `(part9)` (mitre/coalesce interaction fixed, floor back to 3) |
| **Working tree** | clean |
| **Tracked files** | 105 |
